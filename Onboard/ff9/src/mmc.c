...
#define SOCKINS	1 //PORTAbits.RA7           /* Card inserted   (yes:true, no:false, default:true) */

#define	FCLK_SLOW()  SPI1CON1bits.SPRE=0b101; SPI1CON1bits.PPRE = 0b10;	/* Set SPI clock to 333k (Needs to be between 100k-400k) */
#define	FCLK_FAST()  SPI1CON1bits.SPRE=0b110; SPI1CON1bits.PPRE = 0b11;   /* Set SPI clock to 2MHz, (matches power_on() fucntion below, depends on the CSD) */
...
void power_on (void)
{
    SPI1CON1 = 0x013B;	/* Enable SPI1, SPRE = 2:1, PPRE = 1:1 -> 2 MHz */
    SPI1CON2 = 0x0000;
    _SPIEN = 1;
}
